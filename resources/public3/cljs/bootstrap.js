...
goog.net.xpc.CrossPageChannel.prototype.close = function() {
  if(this.isConnected()) {
    this.state_ = goog.net.xpc.ChannelStates.CLOSED, this.transport_.dispose(), this.connectCb_ = this.transport_ = null, this.connectDeferred_ = !1, this.deferredDeliveries_.length = 0, goog.net.xpc.logger.info('Channel "' + this.name + '" closed')
  }
};
...
var func__5161__auto____8405 = function(a, b, c) {
...
var func__5161__auto____8406 = function(a, b) {
...
var func__5161__auto____8407 = function(a, b) {
...
var func__5161__auto____8408 = function(a, b) {
...
var func__5161__auto____8409 = function(a) {
...
waltz.state.has_event_QMARK_ = function(a, b) {
  return waltz.state.get_in_sm.call(null, a, cljs.core.Vector.fromArray(["\ufdd0'events", b]))
};
...
waltz.state.add_event = function(a, b, c) {
  return waltz.state.assoc_sm.call(null, a, cljs.core.Vector.fromArray(["\ufdd0'events", b]), c)
};
  ...
  var a = function(a, b, e) {
    ...
    if(cljs.core.truth_(f)) {
      for(b = cljs.core.first.call(null, f);;) {
        var g = waltz.state.get_in_sm.call(null, a, cljs.core.Vector.fromArray(["\ufdd0'events", b]));
...
jayq.core.ajax = function() {
  ...
  return function(a, c) {
    switch(arguments.length) {
      ...
      case 2:
        return jQuery.ajax(a, jayq.util.clj__GT_js.call(null, c))
    }
    throw"Invalid arity: " + arguments.length;
  }
}();
...
noir.cljs.client.watcher.selector_button = function() {
  var a = function(a, b) {
    ...
    e.setAttribute("crateGroup", group__5148__auto____8245);
    return e
  }, b = function(b, d) {
    var e = null;
    goog.isDef(d) && (e = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1), 0));
...
noir.cljs.client.watcher.selector = function(a) {
  ...
  b.setAttribute("crateGroup", group__5148__auto____8259);
  return b
};
...
var torrent_client = {client:{}};
torrent_client.client.dispatch = {};
  ...
  return a = function(b, c, d) {
    switch(arguments.length) {
      ...
      case 3:
        ...
        cljs.core.swap_BANG_.call(null, torrent_client.client.dispatch.reactions, cljs.core.assoc, e, 0);
        return e
    }
    throw"Invalid arity: " + arguments.length;
  }
}();
torrent_client.client.dispatch.delete_reaction = function(a) {
  return cljs.core.swap_BANG_.call(null, torrent_client.client.dispatch.reactions, cljs.core.dissoc, a)
};
torrent_client.client.dispatch.fire = function() {
  var a = null, b = function(a, b) {
    ...
    }, cljs.core.deref.call(null, torrent_client.client.dispatch.reactions)), f = cljs.core.seq.call(null, e);
    if(cljs.core.truth_(f)) {
      ...
      for(var g = f;;) {
        ...
        }()) ? torrent_client.client.dispatch.delete_reaction.call(null, e) : cljs.core.swap_BANG_.call(null, torrent_client.client.dispatch.reactions, cljs.core.assoc, e, k);
  ...
  return a = function(a, e) {
    switch(arguments.length) {
      ...
      case 1:
        return c.call(this, a);
      case 2:
        var f = cljs.core.ObjMap.fromObject(["\ufdd0'audio", "\ufdd0'video"], {"\ufdd0'audio":!0, "\ufdd0'video":!1});
        return navigator.webkitGetUserMedia(jayq.util.clj__GT_js.call(null, f), a, e)
    }
    throw"Invalid arity: " + arguments.length;
  }
}();
  ...
  return a = function(a) {
    switch(arguments.length) {
      case 0:
        return b.call(this);
      case 1:
        return new webkitPeerConnection00(torrent_client.client.main.stun_server, a)
    }
    throw"Invalid arity: " + arguments.length;
  }
}();
torrent_client.client.main.add_stream = function(a, b) {
  return a.addStream(b)
};
torrent_client.client.main.create_offer = function(a, b) {
  return a.createOffer(jayq.util.clj__GT_js.call(null, b))
};
torrent_client.client.main.create_answer = function(a, b, c) {
  return a.createAnswer(b, jayq.util.clj__GT_js.call(null, c))
};
torrent_client.client.main.set_local_description = function(a, b, c) {
  return a.setLocalDescription(a[cljs.core.name.call(null, b)], c)
};
torrent_client.client.main.set_remote_description = function(a, b, c) {
  return a.setRemoteDescription(a[cljs.core.name.call(null, b)], c)
};
torrent_client.client.main.process_ice_message = function(a, b) {
  return a.processIceMessage(b)
};
torrent_client.client.main.to_sdp = function(a) {
  return a.toSdp()
};
torrent_client.client.main.start_ice = function(a) {
  return a.startIce()
};
torrent_client.client.main.session_description = function(a) {
  return new SessionDescription(a)
};
torrent_client.client.main.transition = function() {
  var a = function(a, b, e, f) {
    return cljs.core.truth_(waltz.state.in_QMARK_.call(null, a, b)) ? waltz.state.set.call(null, a, e, f) : null
  }, b = function(b, d, e, f) {
    var g = null;
    goog.isDef(f) && (g = cljs.core.array_seq(Array.prototype.slice.call(arguments, 3), 0));
    return a.call(this, b, d, e, g)
...
torrent_client.client.main.machine = function(a) {
...
torrent_client.client.main.jsep_machine = function() {
  var a = function(a) {
    var b = torrent_client.client.main.machine.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'label", "\ufdd0'current"], {"\ufdd0'label":"\ufdd0'sup", "\ufdd0'current":"\ufdd0'init"}));
    torrent_client.client.main.get_user_media.call(null, function(a) {
      return waltz.state.trigger.call(null, b, "\ufdd0'add-stream", a)
    });
    var e = torrent_client.client.main.peer_connection.call(null, function(a, c) {
      return waltz.state.trigger.call(null, b, "\ufdd0'add-ice-candidate", a, c)
    });
    waltz.state.add_event.call(null, b, "\ufdd0'add-stream", function(a) {
      torrent_client.client.main.add_stream.call(null, e, a);
      return torrent_client.client.main.transition.call(null, b, "\ufdd0'init", "\ufdd0'has-user-media")
    });
    waltz.state.add_event.call(null, b, "\ufdd0'add-ice-candidate", function(a, c) {
      return cljs.core.truth_(cljs.core.not.call(null, c)) ? torrent_client.client.main.transition.call(null, b, "\ufdd0'has-user-media", "\ufdd0'ready") : null
    });
    waltz.state.add_event.call(null, b, "\ufdd0'receive-offer", function(a) {
      var b = torrent_client.client.main.session_description.call(null, a.call(null, "\ufdd0'sdp")), a = torrent_client.client.main.create_answer.call(null, e, a.call(null, "\ufdd0'sdp"), null);
      torrent_client.client.main.set_remote_description.call(null, e, "\ufdd0'SDP_OFFER", b);
      torrent_client.client.main.set_local_description.call(null, e, "\ufdd0'SDP_ANSWER", a);
      return torrent_client.client.main.start_ice.call(null, e)
    });
    waltz.state.add_event.call(null, b, "\ufdd0'send-offer", function() {
      var a = torrent_client.client.main.create_offer.call(null, e, null);
      torrent_client.client.main.set_local_description.call(null, e, "\ufdd0'SDP_OFFER", a);
      return torrent_client.client.main.start_ice.call(null, e)
    });
    var f = waltz.state.state_STAR_.call(null);
    waltz.state.add_state.call(null, b, "\ufdd0'init", f);
    f = waltz.state.in_STAR_.call(null, waltz.state.state_STAR_.call(null), function() {
      return waltz.state.trigger.call(null, b, a)
    });
    waltz.state.add_state.call(null, b, "\ufdd0'has-user-media", f);
    f = waltz.state.in_STAR_.call(null, waltz.state.state_STAR_.call(null), function() {
      return function() {
        return torrent_client.client.dispatch.fire.call(null, "\ufdd0'ready", e)
      }
    });
    return waltz.state.add_state.call(null, b, "\ufdd0'ready", f)
  }, b = function(b, d) {
    var e = null;
    goog.isDef(d) && (e = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1), 0));
    return a.call(this, b, e)
...
torrent_client.client.dispatch.react_to.call(null, cljs.core.set(["\ufdd0'ready"]), function() {
  return console.log("fired! on ready that is")
});
torrent_client.client.main.jsep_machine.call(null, "\ufdd0'send-offer");
torrent_client.client.main.announce = function(a) {
  return jayq.core.ajax.call(null, "http://localhost:8090/announce", cljs.core.ObjMap.fromObject(["\ufdd0'data", "\ufdd0'dataType", "\ufdd0'success"], {"\ufdd0'data":cljs.core.ObjMap.fromObject(["\ufdd0'sdp", "\ufdd0'info_hash", "\ufdd0'event", "\ufdd0'peer_id", "\ufdd0'numwant"], {"\ufdd0'sdp":a, "\ufdd0'info_hash":"20 chr info hash", "\ufdd0'event":"started", "\ufdd0'peer_id":"some more shit", "\ufdd0'numwant":50}), "\ufdd0'dataType":"json", "\ufdd0'success":function(a) {
    a = cljs.core.js__GT_clj.call(null, a, "\ufdd0'keywordize-keys", !0);
    return torrent_client.client.main.jsep_machine.call(null, "\ufdd0'receive-offer", cljs.core.first.call(null, a.call(null, "\ufdd0'peers")))
  }}))
};
