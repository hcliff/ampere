(ns torrent-client.cljs.peer
  (:use 
    [torrent-client.cljs.protocol.bittorrent :only [generate-protocol]]
    [torrent-client.cljs.waltz :only [machine transition]]
    [torrent-client.cljs.bitfield :only [bitfield-unique]]
    [torrent-client.cljs.pieces :only [wanted-pieces work-piece! piece-blocks get-block]]
    [torrent-client.cljs.peer-id :only [peer-id]]
    )
  (:require
    [torrent-client.cljs.core.dispatch :as dispatch]
    [torrent-client.cljs.protocol.main :as protocol]
